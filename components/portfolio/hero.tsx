  ...
  return (
    <section className="relative flex min-h-[100svh] w-full items-center overflow-hidden px-5 py-24 sm:px-10 lg:px-16">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute right-0 top-0 h-[300px] w-[300px] rounded-full bg-blue-300/10 dark:bg-blue-300/6 blur-[90px]" />
      ...
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-10 lg:grid-cols-[1.3fr_1fr]">
        <div className="flex flex-col">
          ...
          <motion.span
            ...
            className="font-marker text-3xl text-primary italic -rotate-2 sm:text-4xl"
          >
          ...
          <h1 className="mt-2 font-display leading-[0.86] tracking-tight">
            ...
            {/* ELDIN — blue + italic skew */}
            <motion.span
              initial={{ opacity: 0, y: 50, skewY: 4 }}
              animate={showName ? { opacity: 1, y: 0, skewY: 0 } : {}}
              transition={{ duration: 0.7, delay: 0.15, ease: [0.16, 1, 0.3, 1] }}
              className="block text-[20vw] text-primary italic -skew-x-3 sm:text-[15vw] lg:text-[11rem]"
            >
              {profile.lastName}
            </motion.span>
          </h1>

          {/* Tagline — handwriting italic gray */}
          <span className="mt-1 font-marker text-2xl italic -rotate-1 text-foreground/70 sm:text-3xl">
